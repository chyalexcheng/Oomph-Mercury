...
import os
import glob
os.chdir('/storage1/usr/people/cheng/vipr/OomphMercuryCoupling/cmake-build-debug/Drivers/OomphCouplingMultiSolid/1stElement/OneWave/pulse/oneDimChain1P/ref')

#Load data in any order
Data = glob.glob('./OneDimChainMercuryParticle_*.vtu')
...
for x in range(0,maxTime+1):
	DataSorted.append('./OneDimChainMercuryParticle_' + str(x) + '.vtu')
