...
import os
import glob
os.chdir('/storage1/usr/people/cheng/vipr/OomphMercuryCoupling/cmake-build-debug/Drivers/OomphCouplingMultiSolid/1stElement/OneWave/pulse_trueExplicit/safe2/oneDimChain1P/CG1R')
